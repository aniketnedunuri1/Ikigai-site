      ...
      if (typeof ShopifyBuy !== 'undefined') {
        ...
        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: '9721888964924', // T-shirt product ID
            node: document.getElementById('product-component-1728626484156'),
  ...
  return (
    <section className="flex flex-col justify-center items-center min-h-screen space-y-8 mt-10 sm:mt-20">
      ...
      <div className="container mx-auto p-4">
        <div id="product-component-1728626484156"></div> {/* Shopify Buy Button Element */}
      </div>
    </section>
  );
}
