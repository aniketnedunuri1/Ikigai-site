...
//     return (
//         <div className="relative text-white bg-white overflow-hidden min-h-screen flex flex-col">
//             {/* Large title in the background */}
//             <div className='mt-4 ml-2'>

//             <Image src="couture.svg" alt="Couture Logo" width={300} height={400} className="rounded-md" />
//             </div>
...
//                 </p>
//                 {/* <div className="mb-6">
//                     <p>North America - October 18th, 10am PST</p>
//                     <p>UK - October 18th, 10am BST</p>
//                     <p>Europe - October 18th, 10am CEST</p>
//                     <p>Japan & Korea - October 18th, 10am JST/KST</p>
//                 </div> */}
//             </div>
...
//                             <Image src="/gallery/atlas1.png" alt="Image 1" layout="responsive" width={200} height={200} className="rounded-none" />
//                         </div>
//                         <div className="col-span-1 row-span-1 shadow-lg hover:scale-105 transition-transform duration-300">
//                             <Image src="/gallery/atlas2.png" alt="Image 2" layout="responsive" width={200} height={200} className="rounded-none" />
//                         </div>
//                         <div className="col-span-1 row-span-1 shadow-lg hover:scale-105 transition-transform duration-300">
//                             <Image src="/gallery/atlas3.png" alt="Image 3" layout="responsive" width={200} height={200} className="rounded-none" />
//                         </div>
//                         <div className="col-span-1 row-span-1 shadow-lg hover:scale-105 transition-transform duration-300">
//                             <Image src="/gallery/v1ex1.png" alt="Image 4" layout="responsive" width={200} height={200} className="rounded-none" />
//                         </div>
