...
import { submitMailingListForm } from "@/lib/actions";
...
export default function Page() {
  return (
    <div className="cont">
      <div className="big">
        <img src="/couture-ikigai.svg" alt="Couture Ikigai" />
      </div>
      <div className="small-container">
        {[1, 2, 3, 4, 5].map((_, index) => (
          <div key={index} className={`small small-${index + 1}`}>
            <img src="/ikigai-logo.svg" alt="Ikigai Logo" />
          </div>
        ))}
      </div>
    </div>
  ...
  //     setLoading(true);
  //     try {
  //       await submitMailingListForm(values);
  //       toast({
  //         title: "Order Requested Successfully",
  //         description:
  //           "We've received your email request and will process it shortly.",
  //       });
  //       setOpen(false);
  //       form.reset();
  //     } catch (error) {
